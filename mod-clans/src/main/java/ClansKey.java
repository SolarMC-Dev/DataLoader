...
public class ClansKey implements DataKey<ClanPlayer,ClanManager> {

    @Override
    public DataLoader<ClanPlayer> createLoader(ClanManager dataManager, DataKeyInitializationContext context) {
